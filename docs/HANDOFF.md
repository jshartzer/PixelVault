...
- **Docs publish (0.854):** Planning docs consolidated (archive snapshots, slim **`PERFORMANCE_TODO`**, **`CODE_QUALITY_IMPROVEMENT_PLAN`**, stubs for perf/service split). See **`docs/CHANGELOG.md`** **0.854**. **Next trim/optimization priorities:** **`docs/NEXT_TRIM_PLAN.md`**.
