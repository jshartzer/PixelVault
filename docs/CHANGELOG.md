...
- **Import:** **`SaveUndoAndSortAfterImportMoveIfNeeded`** in **`ImportWorkflow`** consolidates undo manifest + destination sort after a successful move (standard, unified, manual intake).
