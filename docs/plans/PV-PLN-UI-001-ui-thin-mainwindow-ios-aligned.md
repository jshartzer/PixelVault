...
| Metric | Apr 6 | Apr 9 | Apr 12 | Apr 17 (plan v2) | Apr 17 (Step 8A) | Apr 17 (Step 8B) | Apr 17 (Step 9) | **Apr 17 (Step 10)** | Direction |
|--------|------:|------:|-------:|------:|------:|------:|------:|------:|-----------|
| `PixelVault.Native.cs` lines | ~2.9k → ~2.1k | ~2.1k | ~1.9k | 2,058 | 1,262 | 1,264 | 1,137 | **931** (−206) | First time under ~1k — Steps 11 + 12 expected to cut another ~100 |
| `MainWindow` partial count | ~40 | ~52 | ~54 | ~55 | ~56 | ~56 | ~56 | **~56** (no partial added — `TroubleshootingLog` is a plain class) | Holds |
| `UI/Library/MainWindow.LibraryCoverResolution.cs` lines | — | — | — | — | 817 | 84 | 84 | **84** | Thin forwarders (no change) |
| `Services/Covers/` cover-resolution surface (lines) | — | — | — | — | — | 749 | 749 | **749** | Holds |
| `UI/Library/LibraryButtonChrome.cs` lines | — | — | — | — | — | — | 190 | **190** | Holds |
| `Infrastructure/TroubleshootingLog.cs` lines | — | — | — | — | — | — | — | **274** (new class) | Log file IO + redaction + rotation |
| `TroubleshootingLogRedactionTests` cases | — | — | — | — | — | — | — | **18** | Guards the "redact paths" user setting |
| Largest non-monolith partial (lines) | — | — | — | 1,088 (`LibraryBrowserViewModel`) | 1,088 | 1,088 | 1,088 | **1,088** | Step 13 target |
| New domain logic in `MainWindow` | Discouraged | — | — | Still discouraged | Still discouraged | Still discouraged | Still discouraged | Still discouraged | **Zero** for new features per `ios_foundation_guide` checklist |

**Target after Steps 8–12:** `PixelVault.Native.cs` under **~900 lines** — essentially fields, ctor delegation, shell glue, and the thin wrappers that partials call. Step 10 already dropped the file to **931 lines**, so either Step 11 or Step 12 will clear the bar.
