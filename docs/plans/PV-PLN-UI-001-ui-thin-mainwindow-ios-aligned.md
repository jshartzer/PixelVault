...
| Metric | Apr 6 | Apr 9 | Apr 12 | Apr 17 (plan v2) | Apr 17 (Step 8A) | Apr 17 (Step 8B) | Apr 17 (Step 9) | Apr 17 (Step 10) | **Apr 17 (Step 11)** | Direction |
|--------|------:|------:|-------:|------:|------:|------:|------:|------:|------:|-----------|
| `PixelVault.Native.cs` lines | ~2.9k → ~2.1k | ~2.1k | ~1.9k | 2,058 | 1,262 | 1,264 | 1,137 | 931 | **802** (−129) | Clears the ~900 target; Step 12 expected to cut another ~50–80 |
| `MainWindow` partial count | ~40 | ~52 | ~54 | ~55 | ~56 | ~56 | ~56 | ~56 | **~56** (no partial added — `PersistentDataMigrator` is a plain static class) | Holds |
| `UI/Library/MainWindow.LibraryCoverResolution.cs` lines | — | — | — | — | 817 | 84 | 84 | 84 | **84** | Thin forwarders (no change) |
| `Services/Covers/` cover-resolution surface (lines) | — | — | — | — | — | 749 | 749 | 749 | **749** | Holds |
| `UI/Library/LibraryButtonChrome.cs` lines | — | — | — | — | — | — | 190 | 190 | **190** | Holds |
| `Infrastructure/TroubleshootingLog.cs` lines | — | — | — | — | — | — | — | 274 | **274** | Holds |
| `Infrastructure/PersistentDataMigrator.cs` lines | — | — | — | — | — | — | — | — | **228** (new class) | First-run migration + open-folder glue |
| `PersistentDataMigratorTests` cases | — | — | — | — | — | — | — | — | **20** | Guards `dist/` probe order, authoritative-destination invariant, README seed |
| `TroubleshootingLogRedactionTests` cases | — | — | — | — | — | — | — | 18 | **18** | Holds |
| Largest non-monolith partial (lines) | — | — | — | 1,088 (`LibraryBrowserViewModel`) | 1,088 | 1,088 | 1,088 | 1,088 | **1,088** | Step 13 target |
| New domain logic in `MainWindow` | Discouraged | — | — | Still discouraged | Still discouraged | Still discouraged | Still discouraged | Still discouraged | Still discouraged | **Zero** for new features per `ios_foundation_guide` checklist |

**Target after Steps 8–12:** `PixelVault.Native.cs` under **~900 lines** — essentially fields, ctor delegation, shell glue, and the thin wrappers that partials call. **Cleared at Step 11 (802 lines).** New bar: Step 12 + Step 13 should leave the monolith in the ~700-line range and push the largest non-monolith partial below ~600.
