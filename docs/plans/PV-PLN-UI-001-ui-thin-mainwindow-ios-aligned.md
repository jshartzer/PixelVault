...
| Metric | Apr 6 | Apr 9 | Apr 12 | Apr 17 (plan v2) | Apr 17 (Step 8A) | Apr 17 (Step 8B) | **Apr 17 (Step 9)** | Direction |
|--------|------:|------:|-------:|------:|------:|------:|------:|-----------|
| `PixelVault.Native.cs` lines | ~2.9k → ~2.1k | ~2.1k | ~1.9k | 2,058 | 1,262 | 1,264 | **1,137** (−127) | Steps 10 → 11 → 12 expected to cut another ~300 |
| `MainWindow` partial count | ~40 | ~52 | ~54 | ~55 | ~56 | ~56 | **~56** (no partial added — `LibraryButtonChrome` is a plain static) | Holds |
| `UI/Library/MainWindow.LibraryCoverResolution.cs` lines | — | — | — | — | 817 | 84 | **84** | Thin forwarders (no change) |
| `Services/Covers/` cover-resolution surface (lines) | — | — | — | — | — | 749 | **749** | Holds |
| `UI/Library/LibraryButtonChrome.cs` lines | — | — | — | — | — | — | **190** (new static) | Pure WPF chrome factories |
| Largest non-monolith partial (lines) | — | — | — | 1,088 (`LibraryBrowserViewModel`) | 1,088 | 1,088 | **1,088** | Step 13 target |
| New domain logic in `MainWindow` | Discouraged | — | — | Still discouraged | Still discouraged | Still discouraged | Still discouraged | **Zero** for new features per `ios_foundation_guide` checklist |
