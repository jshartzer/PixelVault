...
| Metric | Apr 6 | Apr 9 | Apr 12 | Apr 17 (plan v2) | Apr 17 (Step 8A) | Apr 17 (Step 8B) | Apr 17 (Step 9) | Apr 17 (Step 10) | Apr 17 (Step 11) | **Apr 18 (Step 12)** | Direction |
|--------|------:|------:|-------:|------:|------:|------:|------:|------:|------:|------:|-----------|
| `PixelVault.Native.cs` lines | ~2.9k → ~2.1k | ~2.1k | ~1.9k | 2,058 | 1,262 | 1,264 | 1,137 | 931 | 802 | **742** (−60) | Clears the Step-12 + Step-13 goal of ~700 lines in a single slice; next cut depends on Step 13 |
| `MainWindow` partial count | ~40 | ~52 | ~54 | ~55 | ~56 | ~56 | ~56 | ~56 | ~56 | **~56** (no partial added — both new files are plain classes) | Holds |
| `UI/Library/MainWindow.LibraryCoverResolution.cs` lines | — | — | — | — | 817 | 84 | 84 | 84 | 84 | **84** | Holds |
| `Services/Covers/` cover-resolution surface (lines) | — | — | — | — | — | 749 | 749 | 749 | 749 | **749** | Holds |
| `UI/Library/LibraryButtonChrome.cs` lines | — | — | — | — | — | — | 190 | 190 | 190 | **190** | Holds |
| `Infrastructure/TroubleshootingLog.cs` lines | — | — | — | — | — | — | — | 274 | 274 | **274** | Holds |
| `Infrastructure/PersistentDataMigrator.cs` lines | — | — | — | — | — | — | — | — | 228 | **228** | Holds |
| `Infrastructure/TextAndPathHelpers.cs` lines | — | — | — | — | — | — | — | — | — | **166** (new class) | Pure text / path / media-type statics |
| `UI/Library/LibraryPlatformLabels.cs` lines | — | — | — | — | — | — | — | — | — | **85** (new class) | Data-shaped platform labels + WPF badge brush |
| `TextAndPathHelpersTests` cases | — | — | — | — | — | — | — | — | — | **53** | Locks parse / format / media-gate / normalize / library-date behavior |
| `LibraryPlatformLabelsTests` cases | — | — | — | — | — | — | — | — | — | **35** | Locks guess-label branches, Steam-manual-export gate, group order, ARGB brushes |
| `PersistentDataMigratorTests` cases | — | — | — | — | — | — | — | — | 20 | **20** | Holds |
| `TroubleshootingLogRedactionTests` cases | — | — | — | — | — | — | — | 18 | 18 | **18** | Holds |
| Largest non-monolith partial (lines) | — | — | — | 1,088 (`LibraryBrowserViewModel`) | 1,088 | 1,088 | 1,088 | 1,088 | 1,088 | **1,088** | Step 13 target |
| New domain logic in `MainWindow` | Discouraged | — | — | Still discouraged | Still discouraged | Still discouraged | Still discouraged | Still discouraged | Still discouraged | Still discouraged | **Zero** for new features per `ios_foundation_guide` checklist |

**Target after Steps 8–12:** `PixelVault.Native.cs` under **~900 lines** — essentially fields, ctor delegation, shell glue, and the thin wrappers that partials call. **Cleared at Step 11 (802 lines); Step 12 drops another 60 → 742 lines**, which also meets the stretch "Step 12 + Step 13 should leave the monolith in the ~700-line range" — without touching Step 13. Step 13 remains the last planned slice to push the largest non-monolith partial below ~600.
