...
|---------|----------|--------|
| **PV-PLN-RVW-001** | [PV-PLN-RVW-001-post-app-review-hardening.md](PV-PLN-RVW-001-post-app-review-hardening.md) | Post–app-review: **Phase 1** regex (P1) **done**; **Phase 2** hero/banner coalesce + selection cancel **started** in `MainWindow`; Phase 3 structural slice pending. |
