...
| **PV-PLN-LIBWS-001** | [PV-PLN-LIBWS-001-library-workspace-modes.md](PV-PLN-LIBWS-001-library-workspace-modes.md) | Library **workspace modes**: Folder (default), Photo (focused captures), **Timeline (third, distinct)**; shell takeover, manual density, optional rail/hero after core. |
