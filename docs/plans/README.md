...
| **PV-PLN-RVW-001** | *Completed —* [PV-PLN-RVW-001-post-app-review-hardening.md](../completed-projects/PV-PLN-RVW-001-post-app-review-hardening.md) (**Done**) | **Post–app-review (2026-04-12):** P1 **regex** + P2 **hero/banner** dedupe/cancel + P3 **Steam/NonSteamId numeric prefix** hardening (`SteamImportRename`); **`NEXT_TRIM_PLAN.md`** refreshed same day. Stubs: [`plans/PV-PLN-RVW-001-post-app-review-hardening.md`](PV-PLN-RVW-001-post-app-review-hardening.md), [`open/…`](open/PV-PLN-RVW-001-post-app-review-hardening.md). |
...
| **PV-PLN-DIST-001** | [PV-PLN-DIST-001-windows-store-and-distribution-roadmap.md](PV-PLN-DIST-001-windows-store-and-distribution-roadmap.md) | **Distribution roadmap:** Phase 1 ship **1.0** (signing, installer, updater, policies), Phase 2 **Microsoft Store** (Desktop Bridge MSIX), Phase 3 optional **iOS/backend**; risks, scorecard, checklists. |
