    ...
    public sealed partial class MainWindow
    {
        ...
        LibraryFolderInfo CloneLibraryFolderInfo(LibraryFolderInfo folder)
        {
            ...
            return new LibraryFolderInfo
            {
                ...
                IgdbSlug = folder.IgdbSlug,
                IgdbCollectionId = folder.IgdbCollectionId,
                IgdbCollectionName = folder.IgdbCollectionName,
                IgdbFranchiseId = folder.IgdbFranchiseId,
                IgdbFranchiseName = folder.IgdbFranchiseName,
                IgdbSummary = folder.IgdbSummary,
                IgdbReleaseDate = folder.IgdbReleaseDate,
                IgdbGenres = folder.IgdbGenres,
                IgdbPlatforms = folder.IgdbPlatforms,
                IgdbDeveloper = folder.IgdbDeveloper,
                IgdbPublisher = folder.IgdbPublisher,
                IgdbCoverImageId = folder.IgdbCoverImageId,
                IgdbHiddenSeriesIds = folder.IgdbHiddenSeriesIds,
