...
namespace PixelVaultNative
{
    public sealed partial class MainWindow
    {
        ...
        // PV-PLN-UI-001 Step 13 Pass B: timeline date math, packed-card layout, variable-tile sizing
        // and merged-projection fingerprint live in UI/Library/LibraryBrowserViewModelMath.cs (a
        // top-level static class — no MainWindow instance state). These thin static forwarders
        // preserve the `MainWindow.X` surface that MainWindow.LibraryBrowserShowOrchestration,
        // LibraryTimelineModeTests, and LibraryBrowserCombinedMergeTests already reach for. Keep
        // them one-liners; don't grow.
        ...
        // PV-PLN-UI-001 Step 13 Pass B: fingerprint + "All" merge helpers live in
        // LibraryBrowserViewModelMath. Keep these as one-line forwarders.
