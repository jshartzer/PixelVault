    ...
    internal sealed class GameIndexEditorAssignmentService : IGameIndexEditorAssignmentService
    {
        ...
        GameIndexEditorRow CloneGameIndexEditorRow(GameIndexEditorRow row)
        {
            ...
            return new GameIndexEditorRow
            {
                ...
                IgdbId = cleanTag(row.IgdbId ?? string.Empty),
                IgdbSlug = cleanTag(row.IgdbSlug ?? string.Empty),
                IgdbCollectionId = cleanTag(row.IgdbCollectionId ?? string.Empty),
                IgdbCollectionName = cleanTag(row.IgdbCollectionName ?? string.Empty),
                IgdbFranchiseId = cleanTag(row.IgdbFranchiseId ?? string.Empty),
                IgdbFranchiseName = cleanTag(row.IgdbFranchiseName ?? string.Empty),
                IgdbSummary = row.IgdbSummary ?? string.Empty,
                IgdbReleaseDate = cleanTag(row.IgdbReleaseDate ?? string.Empty),
                ...
                IgdbCoverImageId = cleanTag(row.IgdbCoverImageId ?? string.Empty),
