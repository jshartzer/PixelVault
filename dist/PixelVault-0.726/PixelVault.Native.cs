...
namespace PixelVaultNative
{
    ...
    public sealed class MainWindow : Window
    {
        ...
        void QueueImageLoad(Image imageControl, string sourcePath, int decodePixelWidth, Action<BitmapImage> onLoaded, bool prioritize = false)
        {
