    ...
    public sealed class MainWindow : Window
    {
        ...
        void ShowLibraryBrowser(bool reuseMainWindow = false)
        {
            try
            {
                ...
                leftHeader.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(196) });
                leftHeader.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto });
                leftHeader.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto });
                leftHeader.ColumnDefinitions.Add(new ColumnDefinition { Width = GridLength.Auto });
                var titleStack = new StackPanel { Orientation = Orientation.Vertical, VerticalAlignment = VerticalAlignment.Center, Width = 196 };
                var logoPath = ResolveWorkspaceAssetPath("PixelVault.png");
                if (!string.IsNullOrWhiteSpace(logoPath))
                {
                    titleStack.Children.Add(new Image
                    {
                        Source = LoadImageSource(logoPath, 360),
                        Width = 168,
                        Height = 42,
                        Stretch = Stretch.Uniform,
                        HorizontalAlignment = HorizontalAlignment.Left
                ...
                {
                    titleStack.Children.Add(new TextBlock { Text = "PixelVault", FontSize = 22, FontWeight = FontWeights.SemiBold, Foreground = Brushes.White });
                }
                var folderCount = new TextBlock { Text = folders.Count + " folders", Foreground = Brush("#B7C6C0"), VerticalAlignment = VerticalAlignment.Center, FontSize = 13, Margin = new Thickness(0, 8, 0, 0) };
                ...
                importButton.Margin = new Thickness(18, 0, 10, 0);
                ...
                manualImportButton.Margin = new Thickness(0, 0, 18, 0);
                ...
                Grid.SetColumn(importActions, 1);
                ...
                filterGrid.ColumnDefinitions.Add(new ColumnDefinition { Width = new GridLength(196) });
