    ...
    public sealed class MainWindow : Window
    {
        ...
        void ShowLibraryBrowser(bool reuseMainWindow = false)
        {
            try
            {
                ...
                settingsButton.Margin = new Thickness(0, 0, 18, 0);
                ...
                filterGrid.Children.Add(new TextBlock { Text = "Sort", Foreground = Brush("#A7B5BD"), VerticalAlignment = VerticalAlignment.Center, Margin = new Thickness(18, 0, 10, 0) });
                ...
                Grid.SetColumn(sortModeBox, 4);
                filterGrid.Children.Add(sortModeBox);
                ...
                Grid.SetColumn(filterGrid.Children[filterGrid.Children.Count - 1], 5);
                ...
                Grid.SetColumn(folderTileSizeSlider, 6);
                ...
                Grid.SetColumn(folderTileSizeValue, 7);
